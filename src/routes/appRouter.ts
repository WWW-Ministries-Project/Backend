...
import givingOptionRouter from "../modules/finance/GivingOption/route";
...
appRouter.use("/department-join-request", joinRequestRouter);
...
appRouter.use("/givingoption", givingOptionRouter);
