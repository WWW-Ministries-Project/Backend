...
export class ProductController {
  ...
  async updateProductColourStock(req: Request, res: Response) {
    try {
      ...
      return res.status(500).json({
        message: "Failed to update product colour stock: " + error.message,
      });
    }
  }
  ...
  async restoreProduct(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Failed to restore product: " + error.message });
    }
  }
  ...
  async getProductByMarketId(req: Request, res: Response) {
    try {
      ...
      const product = await productService.getProductsByMarketId(
        Number(market_id),
      );
      return res.status(200).json({ data: product });
    } catch (error: any) {
  ...
  async listProductsByMarketId(req: Request, res: Response) {
    try {
      ...
      const product = await productService.listProductsByMarketId(
        Number(market_id),
        filters,
      );
      return res.status(200).json({ data: product });
  ...
  async createSize(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Failed to create size: " + error.message });
    }
  }
  ...
  async createProductType(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Failed to create product type: " + error.message });
    }
  }
  ...
  async updateProductType(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Failed to update product type: " + error.message });
    }
  }
  ...
  async deleteProductType(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Failed to delete product type: " + error.message });
    }
  }
  ...
  async restoreProductType(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Failed to restore product type: " + error.message });
    }
  }
  ...
  async listProductTypes(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Failed to get product types: " + error.message });
    }
  }
  ...
  async createProductCategory(req: Request, res: Response) {
    try {
      ...
      return res.status(500).json({
        message: "Failed to create product category: " + error.message,
      });
    }
  }
  ...
  async updateProductCategory(req: Request, res: Response) {
    try {
      ...
      return res.status(500).json({
        message: "Failed to update product category: " + error.message,
      });
    }
  }
  ...
  async deleteProductCategory(req: Request, res: Response) {
    try {
      const { id } = req.query;
      const productType = await productService.deleteProductCategory(
        Number(id),
      );
      return res.status(200).json({ data: productType });
    } catch (error: any) {
      return res.status(500).json({
        message: "Failed to delete product category: " + error.message,
      });
    }
  }
  ...
  async restoreProductCategory(req: Request, res: Response) {
    try {
      ...
      return res.status(500).json({
        message: "Failed to restore product category: " + error.message,
      });
    }
  }
  ...
  async listProductCategories(req: Request, res: Response) {
    try {
      ...
      return res.status(500).json({
        message: "Failed to get product categories: " + error.message,
      });
    }
  }
}
