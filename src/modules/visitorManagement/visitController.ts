...
export class VisitController {
  async createVisit(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error creating visit", error: error.message });
    }
  }
  ...
  async getVisitById(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error fetching all visits", error: error.message });
    }
  }
  ...
  async updateVisit(req: Request, res: Response) {
    try {
      ...
      return res
        .status(200)
        .json({ message: "Visit updated", data: updatedVisit });
    } catch (error: any) {
      return res
        .status(500)
        .json({ message: "Error updating visit", error: error.message });
    }
  }
  ...
  async deleteVisits(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error deleting visit", error: error.message });
    }
  }
}
