...
visitorRouter.get("/prayerrequests", prayerRequestController.getAllPrayerRequests)
visitorRouter.get("/prayerrequest", prayerRequestController.getPrayerRequestById)
visitorRouter.put("/prayerrequest", prayerRequestController.updatePrayerRequest)
visitorRouter.delete("/prayerrequest", prayerRequestController.deletePrayerRequest)
