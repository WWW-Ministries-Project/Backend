    ...
    async createFollowUp(req: Request, res: Response) {
      ...
      async getAllFollowUps(req: Request, res: Response) {
        try {
          ...
          return res.status(500).json({ message: "Error fetching followups", error: error.message });
        }
      }
      ...
      async getFollowUpById(req: Request, res: Response) {
        try {
          ...
          return res.status(500).json({ message: "Error fetching Follow Up", error: error.message });
        }
      }
      ...
      async updateFollowUp(req: Request, res: Response) {
        try {
          ...
          return res.status(500).json({ message: "Error updating Follow Up", error: error.message });
        }
      }
      ...
      async deleteFollowUp(req: Request, res: Response) {
        try {
          ...
          return res.status(500).json({ message: "Error deleting Follow Up", error: error.message });
        }
      }
    }