...
export class PrayerRequestController {
    ...
    async createPrayerRequest(req: Request, res: Response) {
        try {
          const prayerRequest = await prayerRequestService.createPrayerRequest(req.body);
          return res.status(201).json({ message: "PrayerRequest Added", data: prayerRequest });
        } catch (error:any) {
          return res.status(500).json({ message: "Error creating PrayerRequest", error: error.message });
        }
      }
      ...
      async getAllPrayerRequests(req: Request, res: Response) {
        try {
          ...
          return res.status(500).json({ message: "Error fetching PrayerRequest", error: error.message });
        }
      }
      ...
      async updatePrayerRequest(req: Request, res: Response) {
        try {
          ...
          return res.status(500).json({ message: "Error updating PrayerRequest", error: error.message });
        }
      }
      ...
      async deletePrayerRequest(req: Request, res: Response) {
        try {
          ...
          return res.status(500).json({ message: "Error deleting PrayerRequest", error: error.message });
        }
      }
    }