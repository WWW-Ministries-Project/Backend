...
- Backend is currently configured with permissive CORS for development (`app.use(cors())`).
- Before production, re-enable origin allowlisting to restrict trusted frontend domains.
